...
// hideJockey: ẩn cột Jockey (dùng ở trang Staff Duyệt đăng ký)
export default function RegistrationTable({ rows, onApprove, onReject, hideJockey = false }) {
