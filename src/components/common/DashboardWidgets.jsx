// src/components/common/DashboardWidgets.jsx
// 3 widget dùng chung cho cả 6 dashboard, render bằng .map().
// Đặt ở components/common vì là UI generic, dùng lại nhiều role (Rules Mục 2).
import { Link } from 'react-router-dom';

const GOLD = '#D4AF37';

// Map "accent" -> class viền màu Bootstrap để card có điểm nhấn nhưng vẫn nền tối.
const ACCENT_BORDER = {
  primary: '#0d6efd',
  success: '#198754',
  warning: '#D4AF37',
...
// Lưới các thẻ summary (3-4 thẻ). items: [{ id, label, value, hint, accent }]
...
// Khung "Recent Activity / Upcoming Tasks". items: [{ id, text, time }]
