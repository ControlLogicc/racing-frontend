...
const MENU_CONFIG = {
  ...
  [ROLES.STAFF]: [
    ...
    { path: '/staff/races', label: 'Quản lý Race', icon: <FlagFill /> },
  ...
  [ROLES.SPECTATOR]: [
    ...
    { path: '/spectator/schedule', label: 'Lịch đua', icon: <Calendar3 /> },
    { path: '/spectator/results', label: 'Kết quả đua', icon: <TrophyFill /> },
    { path: '/spectator/rankings', label: 'Bảng xếp hạng', icon: <GraphUpArrow /> },
    { path: '/spectator/horses', label: 'Hồ sơ ngựa', icon: <Search /> },
  ],
};
