// src/pages/referee/Dashboard.jsx
...
// Referee: race được phân công, pre-check/review, nhập kết quả, báo cáo.
const RefereeDashboard = () => {
  const { user } = useAuth();
  const name = user?.fullName || user?.username || user?.name || 'Referee';

  return (
    <div>
      <h2 className="mb-1" style={{ color: GOLD }}>Welcome back, {name} ⚖️</h2>
      <p className="text-muted mb-4">Assigned races, pre-checks, results and reports.</p>
