...
export default function StaffProfilePage() {
  ...
  useEffect(() => {
    staffProfileService.getByUser(user.id)
      .then((p) => {
        setProfile(p);
      ...
      <Row className="g-4">
        <Col lg={7}>
          <div className="dash-card d-flex flex-column gap-4">
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 20 }}>
              <SectionTitle>Thông tin Staff</SectionTitle>
              <ReadonlyField label="Phòng ban" value={profile?.department} />
            </div>
          </div>
        </Col>
        ...
        <Col lg={5}>
          <div className="dash-card h-100">
            ...
            <SummaryRow label="Phòng ban" value={profile?.department} />
          </div>
        </Col>
      </Row>
